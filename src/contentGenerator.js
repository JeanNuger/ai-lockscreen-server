...
const FALLBACK_PHRASES = {
  ...
  ru: [
    'Куртка лучше героизма под дождем',
    'Запасной кабель спасает полдня',
    'Чистые коврики освежают салон',
    'Посадка вещи заметнее бренда',
    'Контекст меняет смысл слова',
    'Подписки любят незаметные списания',
    'Короткая разминка разгружает плечи',
    'Пароль лучше обновлять заранее',
    'Дистанция на дороге бережет нервы',
    'Список покупок экономит деньги',
    'Экран ярче не значит удобнее',
    'Один точный шаг экономит час',
  ],
  zh: [
    '云有时比地面上看起来移动得更快',
    '雨会让城市灯光显得更锋利',
...
Запрет: ?, «пусть», открытки, уют/чай/тихий свет/мысли/мечты/магия/чудеса/счастье/фея/чайник, ночная поэзия про луну/звезды/тишину/шорох/фонари, «верь в себя», «ты справишься», вода, коучинг, команды, выдуманные факты.
